...
Page{
    ...
    TabBar {
        ...
        TabButton { tab: tab1content; text: "2.1.4"; platformInverted: toolBar.platformInverted }
        TabButton { tab: tab2content; text: "2.1.5"; platformInverted: toolBar.platformInverted }
        TabButton { tab: tab3content; text: "2.1.6"; platformInverted: toolBar.platformInverted }
        TabButton { tab: tab4content; text: "2.1.7"; platformInverted: toolBar.platformInverted }
