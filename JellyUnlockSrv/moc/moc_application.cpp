...
**
** Created: Sat 5. Jul 18:36:54 2014
...
static const char qt_meta_stringdata_Application[] = {
    ...
    "GetDate()\0GetDateDrop()\0getTime()\0"
    "aUid\0Launch(QString)\0dx,dy\0"
    "moveWindow(int,int)\0Hide()\0"
};
...
int Application::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 22: { QString _r = GetDateDrop();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 23: { QString _r = getTime();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 24: Launch((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 25: moveWindow((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 26: Hide(); break;
        default: ;
        }
        _id -= 27;
